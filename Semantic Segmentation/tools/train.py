...
def main():
    ...
    cudnn.benchmark = config.CUDNN.BENCHMARK #benchmark mode is good when input sizes for your network do not vary. It will look for the optimal set of algorithms for that configuration
